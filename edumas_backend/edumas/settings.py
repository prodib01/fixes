...
SPECTACULAR_SETTINGS = {
    'TITLE': 'EDUMAS',
    'DESCRIPTION': 'An Education and Management System',
    'VERSION': '1.0.0',
    # Optional: customize here (e.g., SERVE_INCLUDE_SCHEMA)
}
...
WSGI_APPLICATION = 'edumas.wsgi.application'
