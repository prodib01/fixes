...
class Campus(models.Model):
    ...
    email = models.EmailField()
    is_active = models.BooleanField(default=True)
    coordinates = models.DecimalField(max_digits=12, decimal_places=8, blank=True, null=True)
    code = models.CharField(max_length=50)
    director = models.ForeignKey('academics.Staff', on_delete=models.SET_NULL, null=True, blank=True, related_name='directed_campuses')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Department(models.Model):
    ...
    head_of_department = models.ForeignKey('academics.Staff', on_delete=models.SET_NULL, null=True, blank=True, related_name='headed_departments')
    is_active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Event(models.Model):
    ...
    created_by = models.ForeignKey('academics.Staff', on_delete=models.CASCADE, related_name='created_events')
